...
public class FXMLController implements Initializable {
    ...
    private void loadInitialScene()
    {
        ...
        //set some spaceing between the objects in the grid pane.
        ...
        //add the grid to our scrollpane
     ...
     private void loadDetailScene(int current) {
         ...
         if(video.size() > 0)
         {
             ...
             {
                 content = "<iframe width=\"600\" height=\"415\" src=\"https://www.youtube.com/embed/"+videoKey+"\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>";
             }
             else
             {
                 content = "<iframe src=\"https://player.vimeo.com/video/"+ videoKey +"\" width=\"660\" height=\"415\" frameborder=\"0\" allow=\"autoplay; fullscreen\" allowfullscreen></iframe>";                
             }
